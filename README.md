...
- [BNFC/Happy parser](https://hackmd.io/s/ryllVQdIN#)
...
- [Lecture 6.1](https://hackmd.io/s/ryllVQdIN#): How does the LALR(1) parser generated by BNFC and Happy work?  **Homework:** Do the exercise from the lecture notes. This exercise is relevant for tests and final.
