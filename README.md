...
- Lecture 3.2: The aim of this lecture is to understand more about parsing. Some examples of grammars of programming languages are [C](https://cs.wmich.edu/~gupta/teaching/cs4850/sumII06/The%20syntax%20of%20C%20in%20Backus-Naur%20form.htm), [Java](https://docs.oracle.com/javase/specs/jls/se11/html/jls-19.html), [Promela](http://spinroot.com/spin/Man/grammar.html). In the lecture we explained how the grammar of C-- of the [BNFC tutorial](http://bnfc.digitalgrammars.com/tutorial/bnfc-tutorial.html) works. Then we started on Exercise 2 in  [BNFC self check](https://github.com/alexhkurz/compiler-construction/blob/master/BNFC-example.md). Finding the bug in the program of Exercise 2 is **Homework** (to do before the class on Friday, Feb 15).

- Lecture 3.3: The aim of this lecture is to finish the material of Chapter 2 in [the book](http://www.cse.chalmers.se/edu/year/2012/course/DAT150/lectures/plt-book.pdf) and the [slides](http://www.grammaticalframework.org/ipl-book/slides/2-slides-ipl-book.pdf) and of the [BNFC tutorial](http://bnfc.digitalgrammars.com/tutorial/bnfc-tutorial.html). **Homework:**  Finish the [BNFC self check](https://github.com/alexhkurz/compiler-construction/blob/master/BNFC-example.md).
