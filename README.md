...
- BNFC/Happy parser:
  - [the BNFC/Happy `.info`-files and an example of shift-reduce parsing](https://hackmd.io/s/ryllVQdIN)
  - [BNFC/Happy parser](https://hackmd.io/s/S11sLzo84)
  - [How does the LALR(1) parser generated by BNFC and Happy work? A worked example.](https://hackmd.io/s/S11sLzo84)
...
-[Lecture/Lab 6.2](https://hackmd.io/s/rJoVGDh84#): How to eliminate shift/reduce and reduce/reduce conflicts. **Homework:** Do the exercise from the lecture notes. These exercises are relevant for Assignment 2.

- [Lecture 6.3](https://hackmd.io/s/S11sLzo84#): How does the LALR(1) parser generated by BNFC and Happy work?  **Homework:** Do the exercise from the lecture notes. This exercise is relevant for tests and final.
